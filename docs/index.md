...
!!! info
    ...
    **Source Code Repository:** [https://github.com/jdubrick-ai/test-sept5-audio](https://github.com/jdubrick-ai/test-sept5-audio)

    **GitOps Repository:** [https://github.com/jdubrick-ai/test-sept5-audio-gitops](https://github.com/jdubrick-ai/test-sept5-audio-gitops)

# **Usage**

To access the test-sept5-audio application that was deployed using the Software Template, complete the following instructions:
